...
const Tempelate = ({title, description1, description2, image, formType, setIsLoggedIn}) => {
  return (
    <div className="flex w-11/12 max-w-[1160px] py-12 mx-auto gap-y-0 gap-x-12 justify-between">
        ...
        <div className="relative w-11/12 max-w-[450px]">
            ...
            <img src={image} alt='Students' className="absolute -top-4 right-4 " width={558} height={490} loading='lazy'/> 
        </div>
    </div>
  )
}
